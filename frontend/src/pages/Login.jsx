  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B0F19] flex items-center justify-center p-4 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-8 rounded-3xl shadow-xl dark:shadow-[0_0_40px_rgba(139,92,246,0.1)]">
        ...
        <h2 className="text-3xl font-extrabold text-center mb-2 text-gray-900 dark:text-white tracking-tight">Welcome Back</h2>
        <p className="text-center text-gray-500 dark:text-gray-400 mb-8 font-medium">Log in to your workspace.</p>
        ...
        <p className="mt-8 text-center text-gray-500 dark:text-gray-400 font-medium">
          Don't have an account? <Link to="/register" className="text-purple-600 dark:text-purple-400 hover:text-purple-500 underline decoration-2 underline-offset-4">Create one</Link>
        </p>
      </div>
    </div>
  )
